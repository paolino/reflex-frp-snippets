...
description = [here|
Create a number tagged text list, with variable number of tags. 
Here we explore output-switching from a dynamic widget which exposes 
a multifacet signal
|]
...
main = mainWidgetWithAssets 
    "Dynamic List" 
    description  
    $(embedStringFile "NumberTagger.hs") 
